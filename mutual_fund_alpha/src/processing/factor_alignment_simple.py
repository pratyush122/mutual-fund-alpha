"""
Factor Alignment Module (Simple Version)
"""
...
def main():
    ...
    try:
        # Read processed returns data (without trading calendar alignment)
        returns_file = "data/processed/fund_returns.parquet"
        if not os.path.exists(returns_file):
            # Try the original returns file
            returns_file = "data/raw/amfi_nav.parquet"
            if not os.path.exists(returns_file):
